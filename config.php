...
define("IPN_URL", "http://phpdemo.aurfy.com/example/response/ipn.php");//your IPN url, Notice: IPN Url can not be localhost
define("CALLBACK_URL", "http://localhost/demo/example/response/callback.php");//your callback url 